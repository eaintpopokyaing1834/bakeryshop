        ...
        <div class="bg-white rounded-3xl shadow-sm p-8 border border-stone-100">
            ...
            <form method="POST" action="index.php" class="space-y-5" id="loginForm">
                ...
                <div>
                    <div class="flex justify-between items-center mb-2">
                        <label class="block text-sm font-semibold text-gray-700"><?= __('login_password_label') ?></label>
                    </div>
                    <div class="relative">
            ...
            <div class="mt-6 pt-6 border-t border-gray-100 text-center">
                <p class="text-sm text-gray-500">
                    <?= __('login_no_account') ?>
                    <a href="/sweetheaven/auth/register.php" class="text-rose-500 font-semibold hover:text-rose-600 hover:underline ml-1"><?= __('login_signup_link') ?></a>
                </p>
            </div>

            <!-- Demo credentials -->
            <div class="mt-4 bg-rose-50 rounded-xl p-4 text-xs text-gray-500 border border-stone-100">
                <p class="font-semibold text-rose-500 mb-1"><?= __('login_demo_title') ?></p>
                <p><?= __('login_demo_admin') ?></p>
                <p><?= __('login_demo_customer') ?></p>
            </div>
        </div>
