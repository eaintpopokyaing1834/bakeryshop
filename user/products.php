...
if ($search !== '') { $where[] = "(p.name LIKE ? OR p.ingredients LIKE ? OR p.name_my LIKE ? OR p.ingredients_my LIKE ? OR c.name LIKE ? OR c.name_my LIKE ?)"; $params[] = "%$search%"; $params[] = "%$search%"; $params[] = "%$search%"; $params[] = "%$search%"; $params[] = "%$search%"; $params[] = "%$search%"; }
