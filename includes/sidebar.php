...
<aside id="sidebar"
        ...
        <a href="/sweetheaven/admin/dashboard.php" class="flex items-center gap-3 flex-nowrap">
            ...
            <div class="min-w-0">
                ...
                <p class="text-slate-500 text-sm whitespace-nowrap">
                    <?= $role === 'cashier' ? __('cashier_panel') : __('admin_panel') ?></p>
            </div>
        </a>
    </div>
    ...
    <nav class="flex-1 p-4 space-y-1 overflow-y-auto">
        <p class="text-slate-600 text-[11px] font-semibold uppercase tracking-widest px-4 mb-3"><?= __('admin_nav_main') ?></p>
        ...
        <a href="/sweetheaven/admin/dashboard.php"
            ...
            <span><?= __('admin_nav_dashboard') ?></span>
        </a>
        ...
        <a href="/sweetheaven/admin/customize.php"
            ...
            <span><?= __('admin_nav_customize') ?></span>
            <?php
        ...
        <!-- Reviews — both roles (view-only for admin, full manage for cashier) -->
        <a href="/sweetheaven/admin/review.php"
            ...
            <span><?= __('admin_nav_reviews') ?></span>
            <span class="ml-auto text-[9px] font-bold px-1.5 py-0.5 rounded-full shrink-0
                <?= $role === 'cashier'
                    ? 'bg-emerald-100 text-emerald-700'
                    : 'bg-slate-200 text-slate-500' ?>">
                <?= $role === 'cashier' ? 'Manage' : 'View Only' ?>
            </span>
        </a>
        ...
        <a href="/sweetheaven/admin/contact_messages.php"
            class="<?= $baseClass ?> <?= $currentPage === 'contact_messages' ? $activeClass : '' ?>">
            <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                    d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
            </svg>
            <span><?= __('admin_nav_contact_messages') ?></span>
        </a>
        <?php endif; ?>
    ...
    <div class="pt-5 mt-4 border-t border-slate-800">
        <p class="text-stone-500 text-[11px] font-semibold uppercase tracking-widest px-4 mb-3"><?= __('admin_store') ?></p>
