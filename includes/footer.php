            ...
            <div>
                ...
                <ul class="space-y-3 text-stone-500 text-sm">
                    <li class="flex items-start gap-2 break-words">
                        ...
                        <span class="flex-1"><?= __('footer_address') ?></span>
                    </li>
                    <li class="flex items-center gap-2 break-words">
                        ...
                        <span class="flex-1"><?= __('footer_phone') ?></span>
                    </li>
                    <li class="flex items-center gap-2 break-all sm:break-words">
                        ...
                        <span class="flex-1"><?= __('footer_email') ?></span>
                    </li>
...
<script>
window.localizeNumberJS = function(numberStr) {
...
window.formatPriceJS = function(amount) {
    ...
    const currentLang = '<?= currentLang() ?>';
    if (currentLang === 'my') {
        return window.localizeNumberJS(formatted) + ' ကျပ်';
    }
